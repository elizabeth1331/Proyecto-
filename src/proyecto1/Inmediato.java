        ...
        while (st.hasMoreTokens())
        {
            ...
            if(numPalabra==1){
                ...
                if((Extendido.containsKey(palabra))&&!(Directo.containsKey(palabra))&&!(Inmediato.containsKey(palabra))){
                    ...
                    numMemoria = numMemoria + BytesExtendido.get(palabra)+(Extendido.get(palabra)).length()/2;
                    ...
                    //Cálculo del número de espacios de memoria utilizado hasta el momento
                    numMemoria = numMemoria + BytesDirecto.get(palabra)+(Directo.get(palabra)).length()/2;
                    ...
                    //Cálculo del número de espacios de memoria utilizado hasta el momento
                    numMemoria = numMemoria + BytesInmediato.get(palabra)+(Inmediato.get(palabra)).length()/2;
